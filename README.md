...
- integrate a real traffic API
- add shelters, fire stations, and assembly points
- store search history and recent scenarios
- add multilingual support
- improve danger-zone modeling with more validated seismic rules
- support exporting route results or reports
